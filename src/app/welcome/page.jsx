    ...
    <div className="home">
      <div className="welcome">
        ...
        <div className="welcome_detail">
          <p>Connect your Google and Notion accounts to get started.</p>
        </div>
        <div className={styles.welcomecard_container}>
          <RefreshGCalButton text="Step 1: Refresh Google Calendar Account" />
          <RefreshNotionButton text="Step 2: Refresh Notion Database Account" />
